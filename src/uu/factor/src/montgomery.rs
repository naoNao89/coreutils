...
impl MontgomeryContext {
    ...
    pub fn new(n: &BigUint) -> Option<MontgomeryContext> {
...
pub fn montg_mul(a: &BigUint, b: &BigUint, n: &BigUint) -> BigUint {
    if n.is_even() {
...
pub fn batch_montg_mul(operations: &[(BigUint, BigUint)], n: &BigUint) -> Vec<BigUint> {
    if n.is_even() {
