...
pub fn pollard_rho_brent_u64(n: u64) -> Option<u64> {
    ...
    for _attempt in 0..10 {
        let x0 = (n as u128).saturating_mul(1103515245).wrapping_add(12345) as u64 % n;
        let c = (x0 as u128).saturating_mul(1103515245).wrapping_add(12345) as u64 % n;
...
pub fn trial_division_u64(n: &mut u64, mut max_divisor: u64) -> Vec<u64> {
